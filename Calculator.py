...
button_add = Button(root, text="+", padx=39, pady=20, command=button_add, bg= "green", fg = "white")
button_equal = Button(root, text="=", padx=90, pady=20, command=button_equal, bg= "pink", fg = "white")
button_clear = Button(root, text="clear", padx=79, pady=20, command=button_clear, bg= "red", fg = "white")
button_subtract = Button(root, text="-", padx=41, pady=20, command= button_subtract, bg= "orange", fg = "white")
button_multiply = Button(root, text="*", padx=40, pady=20, command=button_multiply, bg= "blue", fg = "white")
button_divide = Button(root, text="/", padx=40, pady=20, command=button_divide, bg= "white", fg = "black")
